                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="#">
                                    ...
                                    <a class="dropdown-item" href="profil.php" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            ...
                            <h4 class="mb-4"> <?= $data['nama']; ?> (<?= $data['npm']; ?>) </h4>
                            <div class="alert alert-success" role="alert">
                                <h4 class="alert-heading"> Langkah - Langkah </h4>
                                <hr />
                                <p> 1. Cari dosen pembimbing anda . </p>
                                <p> 2. Tekan tombol "pilih dosen".</p>
                                <p>3. Upload file anda.</p>
                                <hr />
                                <p class="mb-0">
                                    <a href="Datadosen.php" class="btn btn-success"> Pilih Dosen </a>
                                </p>
                            </div>
                        </div>
                    </div>
