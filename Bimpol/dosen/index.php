    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.php" style="color: gray;">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <img src="../assets/uploads/<?= $data['foto']; ?>" alt="" style="width: 100%;">
                        </div>
                        <div class="col-10">
                            <h3 class="mb-4"> Selamat datang... </h3>
                            <h3 class="mb-4"> Dosen Pembimbing </h3>
                            <h4 class="mb-4"> <?= $data['nama']; ?> (<?= $data['nip']; ?>) </h4>
                            <div class="alert alert-success" role="alert">
                                <h4 class="alert-heading"> Langkah - langkah </h4>
                                <hr />
                                <p> 1. Tekan Tombol Mulai Bimbingan dibawah ini . </p>
                                <p> 2. download file mahasiswa </p>
                                <p>3. Berikan Penilaian Anda.</p>
                                <hr />
                                <p class="mb-0">
                                    <a href="bimbingan.php" class="btn btn-success"> Mulai Bimbingan</a>
                                </p>
                            </div>
                        </div>
                    </div>
